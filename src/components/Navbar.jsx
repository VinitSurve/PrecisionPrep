...
import PrecisionPrepLogo from '../assets/PrecisionPrep.png'; // Adjust the path as necessary
  ...
  return (
    <nav className="navbar">
      <div className="navbar-logo">
        <Link to="/"><img src={PrecisionPrepLogo} width={70} alt="PrecisionPrep Logo"/></Link>
      </div>
